...
- [第1章 专家轨迹、策略与模仿学习目标](chapters/第01章_模仿学习到底在模仿什么.md)
- [第2章 闭环执行模型：策略如何诱导状态分布](chapters/第05章_MDP_模仿学习虽然不要_reward_但也逃不出序列决策.md)
- [第3章 Behavior Cloning：在专家分布上的动作拟合](chapters/第02章_Behavior_Cloning_最朴素也最容易翻车的模仿学习.md)
- [第4章 分布偏移：为什么动作拟合不等于闭环模仿](chapters/第03章_分布偏移_为什么_Behavior_Cloning_会越走越歪.md)
- [第5章 DAgger：把训练分布推向学习策略会遇到的状态](chapters/第04章_DAgger_让老师坐副驾_专治模型越走越歪.md)
