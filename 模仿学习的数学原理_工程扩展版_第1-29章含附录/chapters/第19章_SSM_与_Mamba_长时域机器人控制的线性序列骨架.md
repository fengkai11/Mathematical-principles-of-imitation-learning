...
- Jimmy T. H. Smith, Andrew Warrington, and Scott W. Linderman, “Simplified State Space Layers for Sequence Modeling,” ICLR 2023. <https://arxiv.org/abs/2208.04933>

### 推荐深入阅读

- 先读 S4/S5 的直觉材料，理解状态空间模型如何把历史压进递推状态。
- 再读 Mamba，重点看 selective scan 为什么解决“内容相关记忆选择”的问题。
- 在机器人任务中，建议把 SSM/Mamba 和 Transformer 在延迟、吞吐、上下文长度、可解释调试上做实测对比。
