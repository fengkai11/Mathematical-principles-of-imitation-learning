...
$$
\pi_\theta(a\mid o)
=\mathcal{N}\left(a;f_\theta(o),\sigma^2I\right)
$$
...
$$
\arg\min_\theta[-\log\pi_\theta(a\mid o)]
=
\arg\min_\theta\left\|a-f_\theta(o)\right\|^2
$$
...
=
\arg\min_\theta
\frac{1}{N}\sum_{i=1}^{N}\ell\left(\pi_\theta(\cdot\mid o_i),a_i\right)
$$
