...
$$
\mathcal D_E=\{(s_i,a_i)\}_{i=1}^N \tag{11.2}$$
...
$$
(s_0,a_0),(s_1,a_1),\dots,(s_T,a_T) \tag{11.3}$$

然后，把这些策略样本和专家样本混在一起，交给判别器：

$$
D_\omega(s,a) \tag{11.4}$$
...
$$
\tau=(s_0,a_0,s_1,a_1,\dots,s_T,a_T) \tag{11.5}$$
...
$$
\rho_{\pi_\theta}(s,a) \approx \rho_{\pi_E}(s,a) \tag{11.6}$$
...
$$
D_\omega(s,a)\approx 1 \tag{11.11}$$

表示判别器认为这个 \$(s,a)\$ 更像来自当前策略；

$$
D_\omega(s,a)\approx 0 \tag{11.12}$$
...
=
\frac{\rho_\pi(s,a)}
{\rho_\pi(s,a)+\rho_{\pi_E}(s,a)} \tag{11.17}$$
...
=
\frac{\rho_\pi(s,a)}
{\rho_\pi(s,a)+\rho_{\pi_E}(s,a)} \tag{11.18}$$
...
\mathbb E_{\pi}[\log D(s,a)]
+
\mathbb E_{\pi_E}[\log(1-D(s,a))] \tag{11.20}$$
...
$$
\min_\pi
\mathbb E_{\pi}[\log D(s,a)] \tag{11.21}$$
...
H(\pi(\cdot|s))
=
-\sum_a \pi(a|s)\log \pi(a|s) \tag{11.33}$$
...
H(\pi(\cdot|s))
=
-\sum_a \pi(a|s)\log \pi(a|s) \tag{11.34}$$
...
$$
\tau=(s_0,a_0,s_1,a_1,\dots,s_T,a_T) \tag{11.37}$$
...
p(s_0)
\prod_{t=0}^{T}
\pi(a_t|s_t)P(s_{t+1}|s_t,a_t) \tag{11.38}$$
...
=
\frac{\rho_\pi(s,a)}
{\rho_\pi(s,a)+\rho_{\pi_E}(s,a)} \tag{11.41}$$
...
$$
\tau=(s_0,a_0,s_1,a_1,\dots,s_T,a_T) \tag{11.45}$$
...
p(s_0)
\prod_{t=0}^{T}
\pi(a_t|s_t)P(s_{t+1}|s_t,a_t) \tag{11.46}$$
...
=
\frac{\rho_\pi(s,a)}
{\rho_\pi(s,a)+\rho_{\pi_E}(s,a)} \tag{11.51}$$
...
H(\pi(\cdot|s))
=
-\sum_a \pi(a|s)\log \pi(a|s) \tag{11.54}$$
