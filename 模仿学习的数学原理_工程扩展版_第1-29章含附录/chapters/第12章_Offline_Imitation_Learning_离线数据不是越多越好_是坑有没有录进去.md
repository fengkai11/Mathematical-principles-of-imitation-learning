...
\tau_i
=
(s_0^i,a_0^i,s_1^i,a_1^i,\dots,s_T^i,a_T^i) \tag{12.2}$$
...
\tau_i
=
(o_0^i,a_0^i,o_1^i,a_1^i,\dots,o_T^i,a_T^i) \tag{12.3}$$
...
$$
\mathcal D \sim p_\beta(\tau) \tag{12.10}$$
...
$$
\mathcal D \sim p_\beta(\tau) \tag{12.11}$$
...
$$
\rho_\beta(s,a) \tag{12.12}$$

新策略部署后的访问分布可以写成：

$$
\rho_{\pi_\theta}(s,a) \tag{12.13}$$
...
=
\{(s,a)\mid \rho_\beta(s,a)>0\} \tag{12.16}$$
...
\subseteq
\mathrm{supp}(\rho_\beta) \tag{12.18}$$
...
\mathrm{supp}(\rho_{\pi_\theta})
\nsubseteq
\mathrm{supp}(\rho_\beta) \tag{12.19}$$
...
\mathrm{supp}(\rho_{\pi_\theta})
\nsubseteq
\mathrm{supp}(\rho_\beta) \tag{12.20}$$
...
$$
d\big((s,a),\mathcal D\big) > \epsilon \tag{12.21}$$
...
$$
s_{t+1}\sim P(s_{t+1}|s_t,a_t) \tag{12.22}$$
...
$$
d\big((s,a),\mathcal D\big) > \epsilon \tag{12.23}$$
...
$$
s_{t+1}\sim P(s_{t+1}|s_t,a_t) \tag{12.24}$$
...
\cup
\mathcal D_{\text{boundary}} \tag{12.25}$$
...
\mathcal L_{\text{BC}}(\theta)
+
\lambda\mathcal L_{\text{cons}}(\theta) \tag{12.26}$$
...
\left[c_{\text{ood}}(s,a)\right] \tag{12.27}$$
...
\mathcal L_{\text{BC}}(\theta)
+
\lambda\mathcal L_{\text{cons}}(\theta) \tag{12.29}$$
...
$$
R(\tau)=\sum_{t=0}^{T}\gamma^t r(s_t,a_t) \tag{12.33}$$
...
$$
\prod_{t=0}^{T}
\frac{\pi(a_t|s_t)}{\beta(a_t|s_t)} \tag{12.34}$$
...
\mathcal D
=
\bigcup_{k=1}^{K}\mathcal D^{(k)} \tag{12.36}$$
...
\tau_i
=
(s_0^i,a_0^i,s_1^i,a_1^i,\dots,s_T^i,a_T^i) \tag{12.40}$$
...
$$
\mathcal D\sim p_\beta(\tau) \tag{12.43}$$
...
$$
\mathrm{supp}(p)=\{x\mid p(x)>0\} \tag{12.45}$$
...
\mathrm{supp}(\rho_{\pi_\theta})
\subseteq
\mathrm{supp}(\rho_\beta) \tag{12.46}$$
...
\mathrm{supp}(\rho_{\pi_\theta})
\nsubseteq
\mathrm{supp}(\rho_\beta) \tag{12.47}$$
...
$$
d((s,a),\mathcal D)>\epsilon \tag{12.48}$$
...
$$
s_{t+1}\sim P(s_{t+1}|s_t,a_t) \tag{12.49}$$
...
\mathcal D_{\text{recovery}}
\cup
\mathcal D_{\text{boundary}} \tag{12.50}$$
...
\mathcal L_{\text{BC}}(\theta)
+
\lambda\mathcal L_{\text{cons}}(\theta) \tag{12.51}$$
...
$$
P(a_t|s_{\le t},a_{<t},R_{\le t}) \tag{12.57}$$
