...
- Jie Tan et al., “Sim-to-Real: Learning Agile Locomotion for Quadruped Robots,” RSS 2018. <https://arxiv.org/abs/1804.10332>

### 推荐深入阅读

- 先读 domain randomization，理解为什么随机化视觉、动力学和接触参数能提高真实迁移鲁棒性。
- 读 OpenAI 机械手工作时，重点看 automatic domain randomization 和真实系统评估，而不只看任务结果。
- 对工业机器人，建议把相机标定、时延、摩擦、柔顺性、夹爪磨损和安全区域作为 sim-to-real checklist。
