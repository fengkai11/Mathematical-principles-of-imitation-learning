...
- Anthony Brohan et al., “RT-1: Robotics Transformer for Real-World Control at Scale,” arXiv:2212.06817, 2022.

### 推荐深入阅读

- 把数据闭环拆成采集、清洗、标注、回放、训练、评估、发布、监控、回滚九个环节逐项设计。
- 结合 DPO 和偏好学习材料，思考接管片段如何变成可训练的偏好对或纠偏样本。
- 平台建设优先保证可追踪：数据版本、模型版本、配置版本、代码版本和评估报告必须能互相追溯。
