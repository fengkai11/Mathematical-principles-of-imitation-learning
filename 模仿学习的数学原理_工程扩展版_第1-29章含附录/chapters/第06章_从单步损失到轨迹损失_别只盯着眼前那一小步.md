...
- Sergey Levine, Aviral Kumar, George Tucker, and Justin Fu, “Offline Reinforcement Learning: Tutorial, Review, and Perspectives on Open Problems,” arXiv:2005.01643, 2020. <https://arxiv.org/abs/2005.01643>

### 推荐深入阅读

- 复读 DAgger 论文的误差累积分析，理解为什么单步准确率不能保证轨迹质量。
- 读 Sutton & Barto 中 episode、return、policy evaluation 的定义，把“轨迹级目标”放到 RL 语境下理解。
- 对实机部署，建议把轨迹损失和任务成功率、碰撞率、恢复次数、人工接管次数一起看。
