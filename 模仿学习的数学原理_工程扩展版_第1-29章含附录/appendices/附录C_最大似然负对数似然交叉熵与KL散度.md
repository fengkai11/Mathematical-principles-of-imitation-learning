...
$$
\mathcal D=\{(o_i,a_i)\}_{i=1}^{N} \tag{C.1}$$
...
=
\sum_{i=1}^{N}
\log\pi_\theta(a_i|o_i) \tag{C.6}$$

这个等式来自对数性质：

$$
\log(xy)=\log x+\log y \tag{C.7}$$
...
+
\mathbb E_{(s,a)\sim\rho_{\pi}}[\log(1-D(s,a))] \tag{C.30}$$
